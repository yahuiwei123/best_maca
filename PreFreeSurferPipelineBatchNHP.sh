...
for Subject in $Subjlist ; do
  ...
  . /n01dat01/yhwei/projects/Monkey_Surface/best_maca/SetUpHCPPipelineNHP.sh
  #Input Images
  T1wInputImages=${StudyFolder}/${Subject}/RawData/T1w.nii.gz
  T2wInputImages=${StudyFolder}/${Subject}/RawData/T2w.nii.gz
